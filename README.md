...
The home screen provides the main task management interface where users can view and manage their tasks.

### 📊 Dashboard

![Dashboard](dashboard-screen.png)

The dashboard provides an overview of productivity and task-related statistics.
